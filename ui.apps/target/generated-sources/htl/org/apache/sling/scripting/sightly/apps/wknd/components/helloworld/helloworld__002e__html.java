...
out.write("</h1>\r\n  ");
{
    Object var_testvariable1 = renderContext.getObjectModel().resolveProperty(_global_model, "text");
    if (renderContext.getObjectModel().toBoolean(var_testvariable1)) {
        ...
        {
            String var_2 = ("\r\n" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_global_model, "text"), "text")));
...
out.write("\r\n  ");
{
    ...
    if (renderContext.getObjectModel().toBoolean(var_testvariable3)) {
        ...
        {
            String var_4 = ("\r\n" + renderContext.getObjectModel().toString(renderContext.call("xss", renderContext.getObjectModel().resolveProperty(_global_model, "message"), "text")));
